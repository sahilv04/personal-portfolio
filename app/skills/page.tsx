...
export const metadata = buildMetadata({
  title: "Skills",
  description:
    "Technical skills of Sahil Verma — React, Angular, TypeScript, Node.js, Express, MongoDB, AWS (Cloud Practitioner, Solutions Architect Associate, AI Practitioner), Azure Fundamentals, Docker and Opensource.",
  path: "/skills",
});
